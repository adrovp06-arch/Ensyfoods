      ...
      <section ref={sectionRef} className="bg-[#1B3A6B] py-16 sm:py-20 lg:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            {/* Left column - Info */}
            <div
              className={`transition-all duration-550 ease-out ${isVisible
            ...
            >
              ...
              <p className="mt-6 text-white/60 text-[15px] leading-relaxed max-w-[380px]">
                Usa tu carrito o escríbenos directamente. Confirmación rápida, entrega coordinada.
              </p>

              {/* Info notes */}
              <div
                className={`mt-8 space-y-3 text-white/30 text-[12px] leading-relaxed transition-all duration-550 ease-out ${isVisible
                    ? 'opacity-100 translate-y-0'
                    : 'opacity-0 translate-y-[18px]'
                  }`}
              ...
              >
                <p className="flex items-start gap-2">
                  ...
                  <span>Av. Reforma 7-62 Z.9, Ed. Aristos Reforma, Nivel 6, Of. 607, Guatemala</span>
                </p>
                <p className="flex items-start gap-2">
            ...
            <div
              className={`flex flex-col gap-3 transition-all duration-550 ease-out ${isVisible
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-[18px]'
                }`}
            ...
            >
              ...
              <a
                ...
                aria-label="Contactar por WhatsApp al 5632-9726"
